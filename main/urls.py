...
from .views import index, PostDetailView, akcii, categoryView, AlbomDetail, \
    MachineDetail, PageContentDetailView, AkciiCategoriesDetail, AkciiDetail, SertificatesView, BukletView, ImportantInfoDetailView, OurPartnersView
...
urlpatterns = [
    ...
    path('ourpartners', OurPartnersView, name='ourpartners'),
] 
